...
namespace Eduard.Security.Primitives
{
    ...
    public class ECPoint4w
    {
        ...
        /// <summary>
        /// Creates a <seealso cref="ECPoint4w"/> equal to the point at infinity.
        /// </summary>
        public ECPoint4w()
        {
            this.x = null;
        ...
        /// <summary>
        /// Creates a <seealso cref="ECPoint4w"/> from the modified projective coordinates.
        /// </summary>
        ...
        /// <summary>
        /// Returns a value that indicates whether the Jacobian projective coordinates of two <seealso cref="ECPoint4w"/> objects are equal.
        /// </summary>
        ...
        /// <summary>
        /// Returns a value that indicates whether the Jacobian projective coordinates of two <seealso cref="ECPoint4w"/> objects have different values.
        /// </summary>
        /// <param name="left"></param>
        /// <param name="right"></param>
        /// <returns></returns>
