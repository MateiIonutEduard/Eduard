...
namespace Eduard.Security.Primitives
{
    ...
    public class ECPoint3
    {
        ...
        /// <summary>
        /// Creates a <seealso cref="ECPoint3"/> representing the point at infinity.
        /// </summary>
        public ECPoint3()
        {
            this.x = null;
        ...
        /// <summary>
        /// Creates a <seealso cref="ECPoint3"/> from the given X, Y, and Z projective coordinates.
        /// </summary>
        ...
        {
            get { return new ECPoint3(); }
        }

        /// <summary>
        /// Determines whether the projective coordinates of two <seealso cref="ECPoint3"/> objects are equal.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the projective coordinates of two <seealso cref="ECPoint3"/> objects differ.
        /// </summary>
        /// <param name="left"></param>
        /// <param name="right"></param>
        /// <returns></returns>
